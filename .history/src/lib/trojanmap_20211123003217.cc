...
void cyclehelper(const std::map<std::string, Node> data,std::string currentID,std::unordered_map<std::string, int>& visited_points,std::unordered_map<std::string, std::string>& prev_points,std::vector<std::string>& cycle){
