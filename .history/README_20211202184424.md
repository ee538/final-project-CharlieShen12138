...
```shell
Please input a partial location:k
*************************Results******************************
...
In the first algorithm, the concept is simple, which is to find every possible path and choose the shortest one as our solution, in this
